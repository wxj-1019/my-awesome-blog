          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={cn(
                ...
                autoRefresh ? 'bg-tech-cyan' : 'bg-white/20'
              )}
            >
              <span
                className={cn(
          ...
          <div className="grid grid-cols-3 gap-4 mt-4">
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <div className="flex items-center justify-between mb-2">
                <span className="text-gray-400 text-sm">活跃连接</span>
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <div className="flex items-center justify-between mb-2">
                <span className="text-gray-400 text-sm">响应时间</span>
        ...
        <GlassCardAdmin className="p-6">
          ...
          {status && (
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-gray-400 text-sm">应用状态</span>
              ...
              <div className="space-y-3">
                <span className="text-gray-400 text-sm">依赖服务</span>
                <div className="space-y-2">
                  {Object.entries(status.dependencies).map(([name, depStatus]) => (
                    ...
                    >
                      <div className="flex items-center gap-2">
                        {name === 'database' && <Database className="w-4 h-4 text-gray-400" />}
                        {name === 'redis' && <Zap className="w-4 h-4 text-gray-400" />}
                        {name === 'oss' && <HardDrive className="w-4 h-4 text-gray-400" />}
          ...
          {health && (
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 rounded-lg bg-white/5 border border-white/10">
                <div>
                  <p className="text-white font-medium">{health.service}</p>
                  <p className="text-gray-500 text-sm">版本 {health.version}</p>
                </div>
                <div className="flex items-center gap-2">
          ...
          {analytics && (
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  <span className="text-gray-400 text-sm">总请求数</span>
                ...
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <p className="text-2xl font-bold text-white mt-1">{analytics.active_users}</p>
                </div>
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  <span className="text-gray-400 text-sm">缓存大小</span>
                  <p className="text-2xl font-bold text-white mt-1">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  <span className="text-gray-400 text-sm">平均响应时间</span>
                  <p className="text-xl font-bold text-white mt-1">
                    {analytics.average_response_time.toFixed(1)} ms
                  </p>
                </div>
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  <span className="text-gray-400 text-sm">错误率</span>
                  <p
                    className={cn(
              ...
              <div>
                <span className="text-gray-400 text-sm">热门端点</span>
                  ...
                  {analytics.top_endpoints.map((endpoint, index) => (
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-gray-300 text-sm font-mono">{endpoint.endpoint}</span>
                      </div>
                      <span className="text-gray-500 text-sm">{endpoint.hits.toLocaleString()}</span>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <GlassCardAdmin className="p-4 border-yellow-500/30">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">生产环境请确保关闭调试模式</p>
            </div>
          </div>
        </GlassCardAdmin>
      )}

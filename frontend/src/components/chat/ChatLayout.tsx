 ...
 *
 * z-30：盖住全局 Footer（z-10）。对话页是全屏应用式布局，
 * Footer 在此无意义且会遮挡输入框，故整体提升层级使其不可见。
 */
export function ChatLayout({ children, sidebar, isSidebarOpen }: ChatLayoutProps) {
  return (
    <div className="fixed inset-0 top-16 z-30 flex overflow-hidden bg-transparent text-foreground selection:bg-primary/30">
      {/* Sidebar */}
      {sidebar}
